    ...
    var body: some View {
        NavigationView{
            ZStack{
                ...
                if next9{
                    NavigationLink(destination: NinethView().navigationBarBackButtonHidden(true), isActive: $next9) {
                        EmptyView()
                    }
                    .hidden()
                }
                ...
                if spider01{
                    NavigationLink(destination: Spider1().navigationBarBackButtonHidden(true), isActive: $spider01) {
                        EmptyView()
                    }
                    .hidden()
                }
